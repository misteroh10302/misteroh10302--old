...
<div id="ghostpane"></div>
    ...
    <div class="loading-bar">
      ...
      <canvas id="canvas"></canvas>
          ...
          <?php query_posts('category_name=adeline_home&showposts=15'); ?> 
         ...
         <?php query_posts('category_name=adeline_home&showposts=15'); ?> 
                          ...
                          <div class="mobile-thumb">
                                      ...
                                      <a href="<?php the_permalink(); ?>">
                                              ...
                                              <?php the_post_thumbnail();?>
                                             <span class="cap"> 
                                                 <h2 id="cattop" style="clear:both"><?php $category = get_the_category();echo $category[1]->cat_name;?></h2>
                                                 <h2><?php the_title();?></h2>
                                             </span>
                                             <hr>
                                      </a>
  ...
  $('main').css('opacity','1').fadeIn(0);
   // function to place the thumbnails on the page correctly
    function place() {
      ...
      $(alltheThumbs[2]).css('top',theFirst + 160  +'px' );
      // console.log(alltheThumbs.length);
...
function doDraw() {
  ...
  function calculate() {
    ...
    var theLastTop = thelast[0].offsetTop + theHeight;
...
rotateHandles.each(function(index, handleElement) {
 ...
 console.log('%c :) Website By Done Digital ', 'background-color:red; color: white; font-size: 20px');
