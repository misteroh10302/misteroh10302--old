...
<div id="ghostpane"></div>
	...
	<div id="container" class="content-area container desktop">
      ...
      <canvas id="canvas"></canvas>
          ...
          <?php query_posts('category_name=Editorial&showposts=15'); ?>
  ...
  <div class="mobile">
    <div class="mobile-thumbs">
         <?php query_posts('category_name=Editorial&showposts=-1'); ?>
...
function doDraw() {
  ...
  function calculate() {
    ...
    var theLastTop = thelast[0].offsetTop + theHeight + 1100;
  ...
  function getCoordinates(e) {
    ...
    console.log(currX);
    prevY = currY;
    currX = e.pageX - container.offsetLeft + 20;
