...
<div id="ghostpane"></div>
	...
	<div id="container" class="content-area container desktop">
      ...
      <canvas id="canvas"></canvas>
          ...
          <?php query_posts('category_name='+$variable+'&showposts=15'); ?> 
                                ...
                                <div class="thumb col-2 homepage-posts" href="<?php the_permalink(); ?>">
                                  <div class="drag-me"></div>
                                    <div class="rotate" id="line">
                                       ...
                                       <span class="innerCap"> 
                                           <h2 id="cat-top" style="clear:both"><?php $category = get_the_category();echo $category[1]->cat_name;?></h2>
                                           <h2><?php the_title();?></h2>
                                       </span>
  ...
  <div class="mobile">
    <div class="mobile-thumbs">
         ...
         <?php query_posts('category_name=intimacy&showposts=-1'); ?> 
...
function doDraw() {
 ...
 var thelast = $('.thumb').last();
    ...
    var theLastTop = thelast[0].offsetTop + theHeight+ 60;
  ...
  function getCoordinates(e) {
    ...
    currY = e.pageY - container.offsetTop +20;
  }
